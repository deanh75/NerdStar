...
class ArmFeedforward:
    ...
    """
    WPIStruct: typing.ClassVar[typing.Any]  # value = <capsule object "WPyStruct" at 0xff37ebc4d110>
...
class BangBangController(wpiutil._wpiutil.Sendable):
    ...
    """
    def __init__(self, tolerance: typing.SupportsFloat | typing.SupportsIndex = ...) -> None:
        """
    ...
    def atSetpoint(self) -> bool:
        ...
        """
    @typing.overload
    def calculate(self, measurement: typing.SupportsFloat | typing.SupportsIndex, setpoint: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        ...
        """
    @typing.overload
    def calculate(self, measurement: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns the calculated control output.
    ...
    def setSetpoint(self, setpoint: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
        """
    def setTolerance(self, tolerance: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
...
class ControlAffinePlantInversionFeedforward_1_1:
    ...
    def R(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[1, 1]"]:
        ...
        """
    @typing.overload
    def R(self, i: typing.SupportsInt | typing.SupportsIndex) -> float:
        """
        ...
        """
    @typing.overload
    def __init__(self, f: collections.abc.Callable[[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"], typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"]], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[1, 1]"]], dt: wpimath.units.seconds) -> None:
        """
        ...
        """
    @typing.overload
    def __init__(self, f: collections.abc.Callable[[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"]], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[1, 1]"]], B: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"], dt: wpimath.units.seconds) -> None:
        """
    ...
    def uff(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[1, 1]"]:
        ...
        """
    @typing.overload
    def uff(self, i: typing.SupportsInt | typing.SupportsIndex) -> float:
        """
...
class ControlAffinePlantInversionFeedforward_2_1:
    ...
    def R(self, i: typing.SupportsInt | typing.SupportsIndex) -> float:
        ...
        """
    @typing.overload
    def __init__(self, f: collections.abc.Callable[[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 1]"], typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"]], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[2, 1]"]], dt: wpimath.units.seconds) -> None:
        """
        Constructs a feedforward with given model dynamics as a function
        of state and input.
        ...
        """
    @typing.overload
    def __init__(self, f: collections.abc.Callable[[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 1]"]], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[2, 1]"]], B: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 1]"], dt: wpimath.units.seconds) -> None:
        """
        Constructs a feedforward with given model dynamics as a function of state,
        and the plant's B matrix(continuous input matrix).
...
class ControlAffinePlantInversionFeedforward_2_2:
    ...
    def R(self, i: typing.SupportsInt | typing.SupportsIndex) -> float:
        ...
        """
    @typing.overload
    def __init__(self, f: collections.abc.Callable[[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 1]"], typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 1]"]], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[2, 1]"]], dt: wpimath.units.seconds) -> None:
        """
        Constructs a feedforward with given model dynamics as a function
        of state and input.
        ...
        """
    @typing.overload
    def __init__(self, f: collections.abc.Callable[[typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 1]"]], typing.Annotated[numpy.typing.NDArray[numpy.float64], "[2, 1]"]], B: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 2]"], dt: wpimath.units.seconds) -> None:
        """
        Constructs a feedforward with given model dynamics as a function of state,
        and the plant's B matrix(continuous input matrix).
...
class DifferentialDriveFeedforward:
    ...
    def __init__(self, kVLinear: wpimath.units.volt_seconds_per_meter, kALinear: wpimath.units.volt_seconds_squared_per_meter, kVAngular: wpimath.units.volt_seconds_per_meter, kAAngular: wpimath.units.volt_seconds_squared_per_meter) -> None:
        ...
        :param kAAngular: The angular acceleration gain in volts per (meters per
                          second squared).
        """
    def calculate(self, currentLeftVelocity: wpimath.units.meters_per_second, nextLeftVelocity: wpimath.units.meters_per_second, currentRightVelocity: wpimath.units.meters_per_second, nextRightVelocity: wpimath.units.meters_per_second, dt: wpimath.units.seconds) -> DifferentialDriveWheelVoltages:
        """
        ...
        """
    @property
    def m_kAAngular(self) -> wpimath.units.volt_seconds_squared_per_meter:
        ...
    @property
    def m_kALinear(self) -> wpimath.units.volt_seconds_squared_per_meter:
        ...
    @property
    def m_kVAngular(self) -> wpimath.units.volt_seconds_per_meter:
        ...
    @property
    def m_kVLinear(self) -> wpimath.units.volt_seconds_per_meter:
        ...
class DifferentialDriveWheelVoltages:
    """
    Motor voltages for a differential drive.
    """
    WPIStruct: typing.ClassVar[typing.Any]  # value = <capsule object "WPyStruct" at 0xff37ebc4e280>
...
class ElevatorFeedforward:
    ...
    """
    WPIStruct: typing.ClassVar[typing.Any]  # value = <capsule object "WPyStruct" at 0xff37ebc4e6a0>
...
class ImplicitModelFollower_1_1:
    ...
    def U(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[1, 1]"]:
        ...
        """
    @typing.overload
    def U(self, i: typing.SupportsInt | typing.SupportsIndex) -> float:
        """
...
class LTVDifferentialDriveController:
    ...
    """
    def __init__(self, plant: wpimath._controls._controls.system.LinearSystem_2_2_2, trackwidth: wpimath.units.meters, Qelems: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], Relems: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], dt: wpimath.units.seconds) -> None:
        """
...
class LTVUnicycleController:
    ...
    def __init__(self, dt: wpimath.units.seconds, maxVelocity: wpimath.units.meters_per_second = 9.0) -> None:
        ...
        """
    @typing.overload
    def __init__(self, Qelems: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], Relems: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], dt: wpimath.units.seconds, maxVelocity: wpimath.units.meters_per_second = 9.0) -> None:
        """
...
class LinearQuadraticRegulator_1_1:
    ...
    def K(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[1, 1]"]:
        ...
        """
    @typing.overload
    def K(self, i: typing.SupportsInt | typing.SupportsIndex, j: typing.SupportsInt | typing.SupportsIndex) -> float:
        """
    ...
    def U(self, i: typing.SupportsInt | typing.SupportsIndex) -> float:
        ...
        """
    @typing.overload
    def __init__(self, A: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"], B: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"], Qelems: tuple[typing.SupportsFloat | typing.SupportsIndex], Relems: tuple[typing.SupportsFloat | typing.SupportsIndex], dt: wpimath.units.seconds) -> None:
        """
        Constructs a controller with the given coefficients and plant.
    ...
    def __init__(self, A: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"], B: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"], Q: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"], R: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"], N: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"], dt: wpimath.units.seconds) -> None:
        ...
        """
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_1_1_1, arg1: tuple[typing.SupportsFloat | typing.SupportsIndex], arg2: tuple[typing.SupportsFloat | typing.SupportsIndex], arg3: wpimath.units.seconds) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_1_1_2, arg1: tuple[typing.SupportsFloat | typing.SupportsIndex], arg2: tuple[typing.SupportsFloat | typing.SupportsIndex], arg3: wpimath.units.seconds) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_1_1_3, arg1: tuple[typing.SupportsFloat | typing.SupportsIndex], arg2: tuple[typing.SupportsFloat | typing.SupportsIndex], arg3: wpimath.units.seconds) -> None:
        ...
    @typing.overload
...
class LinearQuadraticRegulator_2_1:
    ...
    def U(self, i: typing.SupportsInt | typing.SupportsIndex) -> float:
        ...
        """
    @typing.overload
    def __init__(self, A: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 2]"], B: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 1]"], Qelems: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], Relems: tuple[typing.SupportsFloat | typing.SupportsIndex], dt: wpimath.units.seconds) -> None:
        """
        Constructs a controller with the given coefficients and plant.
    ...
    def __init__(self, A: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 2]"], B: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 1]"], Q: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 2]"], R: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[1, 1]"], N: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 1]"], dt: wpimath.units.seconds) -> None:
        ...
        """
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_2_1_1, arg1: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg2: tuple[typing.SupportsFloat | typing.SupportsIndex], arg3: wpimath.units.seconds) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_2_1_2, arg1: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg2: tuple[typing.SupportsFloat | typing.SupportsIndex], arg3: wpimath.units.seconds) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_2_1_3, arg1: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg2: tuple[typing.SupportsFloat | typing.SupportsIndex], arg3: wpimath.units.seconds) -> None:
        ...
    @typing.overload
...
class LinearQuadraticRegulator_2_2:
    ...
    def U(self, i: typing.SupportsInt | typing.SupportsIndex) -> float:
        ...
        """
    @typing.overload
    def __init__(self, A: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 2]"], B: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 2]"], Qelems: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], Relems: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], dt: wpimath.units.seconds) -> None:
        """
        Constructs a controller with the given coefficients and plant.
    ...
    def __init__(self, A: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 2]"], B: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 2]"], Q: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 2]"], R: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 2]"], N: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 2]"], dt: wpimath.units.seconds) -> None:
        ...
        """
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_2_2_1, arg1: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg2: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg3: wpimath.units.seconds) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_2_2_2, arg1: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg2: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg3: wpimath.units.seconds) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_2_2_3, arg1: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg2: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg3: wpimath.units.seconds) -> None:
        ...
    @typing.overload
...
class LinearQuadraticRegulator_3_2:
    ...
    def U(self, i: typing.SupportsInt | typing.SupportsIndex) -> float:
        ...
        """
    @typing.overload
    def __init__(self, A: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 3]"], B: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 2]"], Qelems: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], Relems: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], dt: wpimath.units.seconds) -> None:
        """
        Constructs a controller with the given coefficients and plant.
    ...
    def __init__(self, A: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 3]"], B: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 2]"], Q: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 3]"], R: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[2, 2]"], N: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[3, 2]"], dt: wpimath.units.seconds) -> None:
        ...
        """
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_3_2_1, arg1: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg2: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg3: wpimath.units.seconds) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_3_2_2, arg1: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg2: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg3: wpimath.units.seconds) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: wpimath._controls._controls.system.LinearSystem_3_2_3, arg1: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg2: tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], arg3: wpimath.units.seconds) -> None:
        ...
    @typing.overload
...
class PIDController(wpiutil._wpiutil.Sendable):
    ...
    """
    def __init__(self, Kp: typing.SupportsFloat | typing.SupportsIndex, Ki: typing.SupportsFloat | typing.SupportsIndex, Kd: typing.SupportsFloat | typing.SupportsIndex, period: wpimath.units.seconds = 0.02) -> None:
        """
    ...
    def disableContinuousInput(self) -> None:
        ...
        """
    def enableContinuousInput(self, minimumInput: typing.SupportsFloat | typing.SupportsIndex, maximumInput: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
    ...
    def reset(self) -> None:
        ...
        """
    def setD(self, Kd: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
        Sets the differential coefficient of the PID controller gain.
        
        :param Kd: The differential coefficient. Must be >= 0.
        """
    def setI(self, Ki: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
        Sets the integral coefficient of the PID controller gain.
        
        :param Ki: The integral coefficient. Must be >= 0.
        """
    def setIZone(self, iZone: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
        ...
        :param iZone: Maximum magnitude of error to allow integral control. Must be
                      >= 0.
        """
    def setIntegratorRange(self, minimumIntegral: typing.SupportsFloat | typing.SupportsIndex, maximumIntegral: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
        ...
        """
    def setP(self, Kp: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
        Sets the proportional coefficient of the PID controller gain.
        
        :param Kp: The proportional coefficient. Must be >= 0.
        """
    def setPID(self, Kp: typing.SupportsFloat | typing.SupportsIndex, Ki: typing.SupportsFloat | typing.SupportsIndex, Kd: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
    ...
    def setSetpoint(self, setpoint: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
        :param setpoint: The desired setpoint.
        """
    def setTolerance(self, errorTolerance: typing.SupportsFloat | typing.SupportsIndex, errorDerivativeTolerance: typing.SupportsFloat | typing.SupportsIndex = ...) -> None:
        """
...
class ProfiledPIDController(wpiutil._wpiutil.Sendable):
    ...
    profile.
    """
    def __init__(self, Kp: typing.SupportsFloat | typing.SupportsIndex, Ki: typing.SupportsFloat | typing.SupportsIndex, Kd: typing.SupportsFloat | typing.SupportsIndex, constraints: wpimath._controls._controls.trajectory.TrapezoidProfile.Constraints, period: wpimath.units.seconds = 0.02) -> None:
        """
...
class ProfiledPIDControllerRadians(wpiutil._wpiutil.Sendable):
    ...
    profile.
    """
    def __init__(self, Kp: typing.SupportsFloat | typing.SupportsIndex, Ki: typing.SupportsFloat | typing.SupportsIndex, Kd: typing.SupportsFloat | typing.SupportsIndex, constraints: wpimath._controls._controls.trajectory.TrapezoidProfileRadians.Constraints, period: wpimath.units.seconds = 0.02) -> None:
        """
        Allocates a ProfiledPIDController with the given constants for Kp, Ki, and
        Kd. Users should call reset() when they first start running the controller
        to avoid unwanted behavior.
...
class RamseteController:
    ...
    """
    @typing.overload
    def __init__(self, b: typing.SupportsFloat | typing.SupportsIndex, zeta: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
