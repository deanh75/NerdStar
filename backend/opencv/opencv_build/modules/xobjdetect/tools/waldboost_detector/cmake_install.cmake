# Install script for directory: /home/nerdstar/NerdStar/backend/opencv/opencv_contrib/modules/xobjdetect/tools/waldboost_detector
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "main" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE OPTIONAL FILES "/home/nerdstar/NerdStar/backend/opencv/opencv_build/bin/opencv_waldboost_detector")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/opencv_waldboost_detector" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/opencv_waldboost_detector")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/opencv_waldboost_detector"
...
if(CMAKE_INSTALL_LOCAL_ONLY)
  file(WRITE "/home/nerdstar/NerdStar/backend/opencv/opencv_build/modules/xobjdetect/tools/waldboost_detector/install_local_manifest.txt"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
endif()
