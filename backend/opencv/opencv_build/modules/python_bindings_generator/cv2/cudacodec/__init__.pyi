...
class NVSurfaceToColorConverter:
    # Functions
    @_typing.overload
    def convert(self, yuv: cv2.typing.MatLike, surfaceFormat: SurfaceFormat, outputFormat: ColorFormat, color: cv2.typing.MatLike | None = ..., bitDepth: BitDepth = ..., planar: bool = ..., stream: cv2.cuda.Stream = ...) -> tuple[bool, cv2.typing.MatLike]: ...
    @_typing.overload
    def convert(self, yuv: cv2.cuda.GpuMat, surfaceFormat: SurfaceFormat, outputFormat: ColorFormat, color: cv2.cuda.GpuMat | None = ..., bitDepth: BitDepth = ..., planar: bool = ..., stream: cv2.cuda.Stream = ...) -> tuple[bool, cv2.cuda.GpuMat]: ...
    @_typing.overload
    def convert(self, yuv: cv2.UMat, surfaceFormat: SurfaceFormat, outputFormat: ColorFormat, color: cv2.UMat | None = ..., bitDepth: BitDepth = ..., planar: bool = ..., stream: cv2.cuda.Stream = ...) -> tuple[bool, cv2.UMat]: ...
...
@_typing.overload
def createVideoReader(filename: str | os.PathLike[str], sourceParams: _typing.Sequence[int] = ..., params: VideoReaderInitParams = ...) -> VideoReader: ...
@_typing.overload
def createVideoReader(source: RawVideoSource, params: VideoReaderInitParams = ...) -> VideoReader: ...

@_typing.overload
def createVideoWriter(fileName: str | os.PathLike[str], frameSize: cv2.typing.Size, codec: Codec = ..., fps: float = ..., colorFormat: ColorFormat = ..., encoderCallback: EncoderCallback = ..., stream: cv2.cuda.Stream = ...) -> VideoWriter: ...
@_typing.overload
def createVideoWriter(fileName: str | os.PathLike[str], frameSize: cv2.typing.Size, codec: Codec, fps: float, colorFormat: ColorFormat, params: EncoderParams, encoderCallback: EncoderCallback = ..., stream: cv2.cuda.Stream = ...) -> VideoWriter: ...
