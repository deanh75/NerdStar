...
class BackgroundSubtractorMOG(cv2.BackgroundSubtractor):
    ...
    @_typing.overload
    def apply(self, image: cv2.typing.MatLike, knownForegroundMask: cv2.typing.MatLike, learningRate: float, stream: Stream, fgmask: cv2.typing.MatLike | None = ...) -> cv2.typing.MatLike: ...
    @_typing.overload
    def apply(self, image: GpuMat, knownForegroundMask: GpuMat, learningRate: float, stream: Stream, fgmask: GpuMat | None = ...) -> GpuMat: ...
    @_typing.overload
    def apply(self, image: cv2.UMat, knownForegroundMask: cv2.UMat, learningRate: float, stream: Stream, fgmask: cv2.UMat | None = ...) -> cv2.UMat: ...
...
class CascadeClassifier(cv2.Algorithm):
    # Functions
    @classmethod
    def create(cls, filename: str | os.PathLike[str]) -> CascadeClassifier: ...
