...
CVPY_TYPE(MatShape, MatShape, cv::MatShape, MatShape, NoBase, 0, "")
...
CVPY_TYPE(MSTEdge, MSTEdge, cv::MSTEdge, MSTEdge, NoBase, 0, "")
...
CVPY_TYPE(FontFace, FontFace, cv::FontFace, FontFace, NoBase, pyopencv_cv_FontFace_FontFace, "")
...
CVPY_TYPE(TriangleRasterizeSettings, TriangleRasterizeSettings, cv::TriangleRasterizeSettings, TriangleRasterizeSettings, NoBase, 0, "")
CVPY_TYPE(Octree, Octree, Ptr<cv::Octree>, Ptr, NoBase, 0, "")
CVPY_TYPE(RgbdNormals, RgbdNormals, Ptr<cv::RgbdNormals>, Ptr, NoBase, 0, "")
CVPY_TYPE(PoseGraph, detail_PoseGraph, Ptr<cv::detail::PoseGraph>, Ptr, NoBase, 0, ".detail")
CVPY_TYPE(Odometry, Odometry, Ptr<cv::Odometry>, Ptr, NoBase, pyopencv_cv_Odometry_Odometry, "")
CVPY_TYPE(OdometryFrame, OdometryFrame, cv::OdometryFrame, OdometryFrame, NoBase, pyopencv_cv_OdometryFrame_OdometryFrame, "")
CVPY_TYPE(OdometrySettings, OdometrySettings, cv::OdometrySettings, OdometrySettings, NoBase, pyopencv_cv_OdometrySettings_OdometrySettings, "")
CVPY_TYPE(Volume, Volume, Ptr<cv::Volume>, Ptr, NoBase, pyopencv_cv_Volume_Volume, "")
CVPY_TYPE(VolumeSettings, VolumeSettings, cv::VolumeSettings, VolumeSettings, NoBase, pyopencv_cv_VolumeSettings_VolumeSettings, "")
...
CVPY_TYPE(VolumeParams, large_kinfu_VolumeParams, Ptr<cv::large_kinfu::VolumeParams>, Ptr, NoBase, 0, ".large_kinfu")
...
CVPY_TYPE(Tokenizer, dnn_Tokenizer, cv::dnn::Tokenizer, Tokenizer, NoBase, 0, ".dnn")
...
CVPY_TYPE(DISK, DISK, Ptr<cv::DISK>, Ptr, Feature2D, 0, "")
...
CVPY_TYPE(ALIKED, ALIKED, Ptr<cv::ALIKED>, Ptr, Feature2D, 0, "")
CVPY_TYPE(Params, ALIKED_Params, cv::ALIKED::Params, Params, NoBase, pyopencv_cv_ALIKED_Params_ALIKED_Params, ".ALIKED")
...
CVPY_TYPE(LightGlueMatcher, LightGlueMatcher, Ptr<cv::LightGlueMatcher>, Ptr, DescriptorMatcher, 0, "")
CVPY_TYPE(ANNIndex, ANNIndex, Ptr<cv::ANNIndex>, Ptr, NoBase, 0, "")
...
CVPY_TYPE(CChecker, mcc_CChecker, Ptr<cv::mcc::CChecker>, Ptr, Algorithm, 0, ".mcc")
CVPY_TYPE(DetectorParametersMCC, mcc_DetectorParametersMCC, cv::mcc::DetectorParametersMCC, DetectorParametersMCC, NoBase, pyopencv_cv_mcc_mcc_DetectorParametersMCC_DetectorParametersMCC, ".mcc")
...
CVPY_TYPE(ECCParameters, ECCParameters, cv::ECCParameters, ECCParameters, NoBase, pyopencv_cv_ECCParameters_ECCParameters, "")
...
CVPY_TYPE(BRISK, xfeatures2d_BRISK, Ptr<cv::xfeatures2d::BRISK>, Ptr, Feature2D, 0, ".xfeatures2d")
CVPY_TYPE(AgastFeatureDetector, xfeatures2d_AgastFeatureDetector, Ptr<cv::xfeatures2d::AgastFeatureDetector>, Ptr, Feature2D, 0, ".xfeatures2d")
CVPY_TYPE(KAZE, xfeatures2d_KAZE, Ptr<cv::xfeatures2d::KAZE>, Ptr, Feature2D, 0, ".xfeatures2d")
CVPY_TYPE(AKAZE, xfeatures2d_AKAZE, Ptr<cv::xfeatures2d::AKAZE>, Ptr, Feature2D, 0, ".xfeatures2d")
CVPY_TYPE(BOWTrainer, xfeatures2d_BOWTrainer, Ptr<cv::xfeatures2d::BOWTrainer>, Ptr, NoBase, 0, ".xfeatures2d")
CVPY_TYPE(BOWKMeansTrainer, xfeatures2d_BOWKMeansTrainer, Ptr<cv::xfeatures2d::BOWKMeansTrainer>, Ptr, xfeatures2d_BOWTrainer, pyopencv_cv_xfeatures2d_xfeatures2d_BOWKMeansTrainer_BOWKMeansTrainer, ".xfeatures2d")
CVPY_TYPE(BOWImgDescriptorExtractor, xfeatures2d_BOWImgDescriptorExtractor, Ptr<cv::xfeatures2d::BOWImgDescriptorExtractor>, Ptr, NoBase, pyopencv_cv_xfeatures2d_xfeatures2d_BOWImgDescriptorExtractor_BOWImgDescriptorExtractor, ".xfeatures2d")
...
CVPY_TYPE(NVSurfaceToColorConverter, cudacodec_NVSurfaceToColorConverter, Ptr<cv::cudacodec::NVSurfaceToColorConverter>, Ptr, NoBase, 0, ".cudacodec")
...
CVPY_TYPE(LightGlueFeaturesMatcher, detail_LightGlueFeaturesMatcher, Ptr<cv::detail::LightGlueFeaturesMatcher>, Ptr, detail_FeaturesMatcher, pyopencv_cv_detail_detail_LightGlueFeaturesMatcher_LightGlueFeaturesMatcher, ".detail")
