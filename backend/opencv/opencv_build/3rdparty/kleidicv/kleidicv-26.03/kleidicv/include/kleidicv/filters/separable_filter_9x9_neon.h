...
#ifndef KLEIDICV_SEPARABLE_FILTER_9X9_NEON_H
#define KLEIDICV_SEPARABLE_FILTER_9X9_NEON_H
 ...
 public:
  ...
  void process_horizontal(size_t width, Rows<const BufferType> src_rows,
    ...
    loop.unroll_twice([&](size_t index) {
      ...
      BufferVectorType src_a[9], src_b[9];
...
#endif  // KLEIDICV_SEPARABLE_FILTER_9X9_NEON_H
