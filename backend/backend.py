...
from workers.apriltag_worker import apriltag_worker
...
from workers.objdetect_worker import objdetect_worker
...
from pipeline.Capture import AVFoundationMjpegCapture
...
class Backend:
    ...
    capture: AVFoundationMjpegCapture = AVFoundationMjpegCapture()
